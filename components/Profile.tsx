    ...
    <div className="pb-24 min-h-full dark:text-gray-100 animate-fade-in">
      ...
      <div className="flex flex-col items-center mb-8">
        <div className="relative group">
          <div
            className={`w-24 h-24 rounded-full p-1 ${user.isPremium ? 'bg-gradient-to-tr from-yellow-400 to-orange-500' : 'bg-gray-200 dark:bg-gray-700'}`}
          >
            <img
              src={user.avatar}
              alt="Profile"
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-[10px] text-gray-400 mt-1">
                Sert à localiser les magasins autour de chez toi.
              </p>
            </div>
            ...
            <label className="flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-xl cursor-pointer">
              ...
              <div className="flex items-center gap-2">
                <ArrowUpCircle
                  size={16}
                  className={housing.hasElevator ? 'text-green-500' : 'text-gray-400'}
                />
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 mb-6 shadow-sm border border-gray-100 dark:border-gray-700">
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400">
          Activez cette option si vous êtes suivi par un travailleur social (CCAS, Mission Locale,
          FJT). Cela débloque des outils de reporting et des tâches administratives spécifiques
          (Aides FSL, Visale...).
        </p>
      </div>
      ...
      {/* Subscription Card */}
      <div
        className={`rounded-2xl p-6 mb-6 shadow-sm border relative overflow-hidden ${
          user.isPremium
        ...
        {user.isPremium ? (
          <>
            ...
            <div className="relative z-10 flex justify-between items-start">
              <div>
                ...
                <p className="text-gray-400 text-sm">
                  Prochain prélèvement le 01/{new Date().getMonth() + 2}/{new Date().getFullYear()}
                </p>
              </div>
            ...
            <div className="mt-6 flex gap-3">
              ...
              <button className="flex-1 text-gray-400 hover:text-white text-sm">Factures</button>
            </div>
          </>
        ) : (
          <>
            <div className="flex justify-between items-start mb-4">
              <div>
                <div className="bg-gray-100 dark:bg-gray-700 text-gray-500 text-xs font-bold px-2 py-1 rounded inline-block mb-2">
                  GRATUIT
                </div>
            ...
            <ul className="space-y-2 mb-6 text-sm text-gray-600 dark:text-gray-300">
              <li className="flex gap-2">
                <Crown size={16} className="text-yellow-500" /> Assistant IA Illimité
              </li>
              <li className="flex gap-2">
                <Crown size={16} className="text-yellow-500" /> Sauvegarde Cloud
              </li>
              <li className="flex gap-2">
                <Crown size={16} className="text-yellow-500" /> Support Prioritaire
              </li>
            </ul>
            <button
              onClick={onUpgrade}
